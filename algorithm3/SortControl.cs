...
namespace algorithm3
{
    public partial class SortControl : UserControl
    {
        ...
        public SortControl(Form1 parentForm)
        {
            InitializeComponent();
            DoubleBuffered = true;
        ...
        private async Task shakerSort(int[] arr)
        {
            left = 0;
            right = arr.Length - 1;
            if (sorting)
            {
                ...
                while (left < right)
                {
                    if (sorting)
                    {
                        if (sortingComplete)
                        {
                            break; // Завершите сортировку, если флаг установлен
                        }
                        for (int i = left; i < right; i++)
                        {
                            if (sorting)
                            {
                                ...
                                {
                                    Swap(arr, i, i + 1);
                                    currentIndex = i + 1; // Перемещается вправо
                                }
                        ...
                        for (int i = right; i > left; i--)
                        {
                            if (sorting)
                            {
                                ...
                                {
                                    Swap(arr, i - 1, i);
                                    currentIndex = i - 1; // Перемещается влево
                                }
                                await Task.Delay(10); // Анимация с задержкой
                            }
                        }
                        ...
                        leftSortedBoundary = left;
                        rightSortedBoundary = right;
                    }
                    else
                    {
                        break;
                    ...
                    // Проверяем, была ли сортировка остановлена
                    if (!sorting)
                    {
                        break;
                    }

                    // Если сортировка остановлена, сохраняем текущее состояние
                    left = startLeft;
                    right = startRight;
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            parentForm.resultControl.alg_type = 1;
